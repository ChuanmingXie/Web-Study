...
function appendRow(index) {
  ...
  toolCell.innerHTML = '<input type="image" src="./img/filetool/delete.png" alt="删除" onclick="deleteRow(this)"> ' + '<input type="image" src="./img/filetool/detail.png" alt="详情"> ' + '<input type="image" src="./img/filetool/create.png" alt="编辑">';
}
