...
function showHotGoods() {
	...
	for (var i = 0; i < turnShow.length; i++) {
		...
		adviseContent += '<li><a href="' + hotGoods.data[index].href +
			'"><img src="' + hotGoods.srcPath + hotGoods.data[index].src + '" width="80" height="80" >' +
			'</a><p class="price2">￥' + hotGoods.data[index].price + '元</p></li>';
	}
	adviseContent += '</ul>';
