...
function showFirstList() {
  ...
  var arraydescibe = ['2023夏季新款韩版 修身上上羽绒服', '2023夏季古风踏青 飘逸秦汉尚武风', '2023球衣运动先锋 球场洒脱有灵动', '2023夏季新款韩版 修身上上羽绒服', '2023夏季新款韩版 修身上上羽绒服', '2023夏季古风踏青 飘逸秦汉尚武风', '2023球衣运动先锋 球场洒脱有灵动', '2023夏季新款韩版 修身上上羽绒服'];
  /* 
  <dl>
      <div>
  ...
  */
  ...
  arrayimgs.forEach(function (s, index, current) {
    htmlInfo += imgpre + current[index] + pricepre + arrayprice[index] + numberpre + arrayamount[index] + desibepre + arraydescibe[index] + "</dd></dl>";
  });
...
function showSecondList() {
  ...
  var arraydescibe = ['欧美潮牌顶级时装设计 时装定制 针织衫polo衫', '古风设计复古时装设计 潮流定制 复古风秦汉服', '民族特色中西合璧设计 相得益彰 名族传统世界', '夏季短裤中的清凉一夏 如沐春风 吸汗透气清凉'];
  /* 
  <li>
  ...
  */
  ...
  var imgpre = '<li><div><a href="Pro-goodDetail.html"><img src="' + '../' + 'Chapter09/img/goodshow/';
  var desibepre = '" alt=""></a></div><p>';
  var htmlInfo = "";
  arrayimgs.forEach(function (s, i, element) {
    htmlInfo += imgpre + element[i] + desibepre + arraydescibe[i] + "</p></li>";
  });
