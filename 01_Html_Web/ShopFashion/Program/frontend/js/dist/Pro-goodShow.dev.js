...
function goodListInit1() {
  ...
  var arraydescibe = ['2022夏季新款韩版 修身上上羽绒服', '2022夏季古风踏青 飘逸秦汉尚武风', '2022球衣运动先锋 球场洒脱有灵动', '2022夏季新款韩版 修身上上羽绒服', '2022夏季新款韩版 修身上上羽绒服', '2022夏季古风踏青 飘逸秦汉尚武风', '2022球衣运动先锋 球场洒脱有灵动', '2022夏季新款韩版 修身上上羽绒服'];
  ...
  for (var i = 0; i < arrayimgs.length; i++) {
    element += imgpre + arrayimgs[i] + pricepre + arrayprice[i] + amountpre + arrayamount[i] + describepre + arraydescibe[i] + "</dd></dl>";
  }
...
function goodListInit2() {
  ...
  for (var i = 0; i < arrayimgs.length; i++) {
    element += imgpre + arrayimgs[i] + describepre + arraydescibe[i] + '</p></li>';
  }
